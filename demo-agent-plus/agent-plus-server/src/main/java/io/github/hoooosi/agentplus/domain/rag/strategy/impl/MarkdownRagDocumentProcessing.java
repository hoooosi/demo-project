package io.github.hoooosi.agentplus.domain.rag.strategy.impl;

import com.baomidou.mybatisplus.core.conditions.update.LambdaUpdateWrapper;
import com.baomidou.mybatisplus.core.toolkit.Wrappers;
import io.github.hoooosi.agentplus.domain.rag.message.RagDocMessage;
import io.github.hoooosi.agentplus.domain.rag.model.ProcessedSegment;
import io.github.hoooosi.agentplus.domain.rag.repository.DocumentUnitRepository;
import io.github.hoooosi.agentplus.domain.rag.repository.FileDetailRepository;
import io.github.hoooosi.agentplus.domain.rag.strategy.context.ProcessingContext;
import io.github.hoooosi.agentplus.infrastructure.rag.processor.DocumentVectorizationOrchestrator;
import io.github.hoooosi.agentplus.infrastructure.rag.processor.StructuralMarkdownProcessor;
...
public class MarkdownRagDocumentProcessing extends AbstractDocumentProcessingStrategy {
    ...
    // 用于存储当前处理的文件ID
    private Long currentProcessingFileId;
