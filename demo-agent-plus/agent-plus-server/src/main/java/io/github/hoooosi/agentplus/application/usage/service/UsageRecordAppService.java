package io.github.hoooosi.agentplus.application.usage.service;

import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import io.github.hoooosi.agentplus.application.usage.assembler.UsageRecordAssembler;
...
import io.github.hoooosi.agentplus.domain.user.service.UsageRecordDomainService;
...
public class UsageRecordAppService {
     ...
     * @param size 每页大小
     * @return 使用记录分页结果 */
    public Page<UsageRecordDTO> getUserUsageRecords(Long userId, int page, int size) {
