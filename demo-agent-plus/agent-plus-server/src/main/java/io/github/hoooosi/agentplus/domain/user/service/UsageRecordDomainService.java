...
import io.github.hoooosi.agentplus.domain.user.repository.UsageRecordRepository;
...
public class UsageRecordDomainService {
     ...
     * @param pageSize 每页大小
     * @return 用量记录分页结果 */
    public Page<UsageRecordEntity> getUserUsageHistory(Long userId, int pageNum, int pageSize) {
        if (userId == null) {
