package io.github.hoooosi.agentplus.infrastructure.rag.service;
...
public class UserModelConfigResolver {
    ...
    public ModelConfig getUserEmbeddingModelConfig(Long userId) {
        try {
            ...
            Long modelId = userSettingsDTO.getSettingConfig().getDefaultEmbeddingModel();
    ...
    public ModelConfig getUserChatModelConfig(Long userId) {
        try {
            UserSettingsDTO userSettingsDTO = userSettingsAppService.getUserSettings(userId);
            ...
            Long modelId = userSettingsDTO.getSettingConfig().getDefaultModel();
    ...
    public ModelConfig getUserOcrModelConfig(Long userId) {
        try {
            UserSettingsDTO userSettingsDTO = userSettingsAppService.getUserSettings(userId);
            ...
            Long modelId = userSettingsDTO.getSettingConfig().getDefaultOcrModel();
    ...
    private ModelConfig getModelConfigFromDatabase(Long modelId, Long userId) {
        try {
            // 获取模型实体
