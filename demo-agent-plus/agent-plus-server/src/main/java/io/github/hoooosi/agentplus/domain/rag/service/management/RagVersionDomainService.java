...
import io.github.hoooosi.agentplus.domain.rag.constant.RagPublishStatus;
import io.github.hoooosi.agentplus.domain.rag.model.*;
import io.github.hoooosi.agentplus.domain.rag.repository.*;
import io.github.hoooosi.agentplus.domain.rag.service.RagQaDatasetDomainService;
...
public class RagVersionDomainService {
    ...
    private void copyFilesAndDocuments(Long ragId, Long ragVersionId) {
        // 获取原始文件列表
    ...
    private void copyDocumentUnits(Long originalFileId, Long ragVersionId, Long ragVersionFileId) {
