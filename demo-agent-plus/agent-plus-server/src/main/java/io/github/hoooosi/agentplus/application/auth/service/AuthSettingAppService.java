package io.github.hoooosi.agentplus.application.auth.service;

import io.github.hoooosi.agentplus.application.auth.assembler.AuthSettingAssembler;
import io.github.hoooosi.agentplus.application.auth.dto.AuthConfigDTO;
import io.github.hoooosi.agentplus.application.auth.dto.AuthSettingDTO;
import io.github.hoooosi.agentplus.application.auth.dto.LoginMethodDTO;
import io.github.hoooosi.agentplus.application.auth.dto.UpdateAuthSettingRequest;
import io.github.hoooosi.agentplus.domain.auth.constant.AuthFeatureKey;
import io.github.hoooosi.agentplus.domain.auth.constant.FeatureType;
...
public class AuthSettingAppService {
     ...
     * @param id 配置ID
     * @return 认证配置DTO */
    public AuthSettingDTO getAuthSettingById(Long id) {
     ...
     * @param id 配置ID
     * @return 更新后的配置DTO */
    public AuthSettingDTO toggleAuthSetting(Long id) {
     ...
     * @param request 更新请求
     * @return 更新后的配置DTO */
    public AuthSettingDTO updateAuthSetting(Long id, UpdateAuthSettingRequest request) {
        AuthSettingEntity entity = authSettingDomainService.getById(id);
